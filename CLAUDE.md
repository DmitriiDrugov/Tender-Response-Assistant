...
3. `CLAUDE_REVIEW.local.md` — local review notes, if present
...
- Editing files in `src/`, `PRODUCT.md`, `AGENTS.md`, `CLAUDE.md`, `CODEX.md`
...
- The "thinking" indicator is a 1px ink-stroke animation, not a spinner.
...
- Add a `border-l-*` side stripe to any card or row
